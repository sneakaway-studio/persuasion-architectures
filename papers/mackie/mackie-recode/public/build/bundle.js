...
var app = (function () {
	...
	function create_if_block(ctx) {
		let t0_value = console.log(/*$images*/ ctx[1][/*index*/ ctx[8]]) + "";
		let t0;
		let t1;
		let div;
		...
		const block = {
			c: function create() {
				...
				t1 = space();
				div = element("div");
				attr_dev(div, "class", "image svelte-1hnraln");
				set_style(div, "background-image", "url(" + /*$images*/ ctx[1][/*index*/ ctx[8]].tile.img_url + ")");
				set_style(div, "width", "100%");
				add_location(div, file$2, 121, 7, 3173);
			},
			m: function mount(target, anchor) {
			...
			p: function update(ctx, dirty) {
				if (dirty & /*$images, $randomIndices*/ 3 && t0_value !== (t0_value = console.log(/*$images*/ ctx[1][/*index*/ ctx[8]]) + "")) set_data_dev(t0, t0_value);
	...
	function create_each_block(ctx) {
		...
		const block = {
			c: function create() {
				...
				attr_dev(button, "class", "btn btn-link p-1 no-border svelte-1hnraln");
				button.disabled = button_disabled_value = /*$images*/ ctx[1][/*index*/ ctx[8]].matched;
				add_location(button, file$2, 109, 4, 2798);
				attr_dev(div1, "class", div1_class_value = "col-3 col-sm-3 col-lg-3 col" + /*$images*/ ctx[1][/*index*/ ctx[8]].id + " d-flex justify-content-center g-0 colClass" + " svelte-1hnraln");
			...
			p: function update(new_ctx, dirty) {
				...
				if (dirty & /*$images, $randomIndices*/ 3 && div1_class_value !== (div1_class_value = "col-3 col-sm-3 col-lg-3 col" + /*$images*/ ctx[1][/*index*/ ctx[8]].id + " d-flex justify-content-center g-0 colClass" + " svelte-1hnraln")) {
	...
	function create_fragment$2(ctx) {
		...
		const block = {
			...
			p: function update(ctx, [dirty]) {
				if (dirty & /*$images, $randomIndices, handleTileClick, console*/ 7) {
