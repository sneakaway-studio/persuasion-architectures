...
var app = (function () {
	...
	// (120:6) {#if $images[index].isRevealed}
	function create_if_block(ctx) {
		...
		const block = {
			c: function create() {
				div = element("div");
				attr_dev(div, "class", "image svelte-d7p2ol");
				set_style(div, "background-image", "url(" + /*$images*/ ctx[1][/*index*/ ctx[8]].img_url + ")");
				set_style(div, "width", "100%");
				add_location(div, file$2, 120, 7, 3136);
			},
			m: function mount(target, anchor) {
		...
		dispatch_dev("SvelteRegisterBlock", {
			...
			type: "if",
			source: "(120:6) {#if $images[index].isRevealed}",
			ctx
		});
	...
	// (105:2) {#each $randomIndices as index}
	function create_each_block(ctx) {
		...
		let mounted;
		let dispose;
		let if_block = /*$images*/ ctx[1][/*index*/ ctx[8]].isRevealed && create_if_block(ctx);
		...
		const block = {
			c: function create() {
				...
				attr_dev(div0, "class", div0_class_value = "card " + (/*$images*/ ctx[1][/*index*/ ctx[8]].isRevealed
				? 'revealed'
				: '') + " " + (/*$images*/ ctx[1][/*index*/ ctx[8]].matched
				? 'matched'
				: '') + " mb-1" + " svelte-d7p2ol");

				add_location(div0, file$2, 114, 5, 2953);
				attr_dev(button, "class", "btn btn-link p-1 no-border svelte-d7p2ol");
				button.disabled = button_disabled_value = /*$images*/ ctx[1][/*index*/ ctx[8]].matched;
				add_location(button, file$2, 109, 4, 2798);
				attr_dev(div1, "class", div1_class_value = "col-3 col-sm-3 col-lg-3 col" + /*$images*/ ctx[1][/*index*/ ctx[8]].id + " d-flex justify-content-center g-0 colClass" + " svelte-d7p2ol");
				add_location(div1, file$2, 105, 3, 2676);
			},
			m: function mount(target, anchor) {
				insert_dev(target, div1, anchor);
			...
			p: function update(new_ctx, dirty) {
				...
				if (/*$images*/ ctx[1][/*index*/ ctx[8]].isRevealed) {
					if (if_block) {
						if_block.p(ctx, dirty);
					} else {
				...
				if (dirty & /*$images, $randomIndices*/ 3 && div0_class_value !== (div0_class_value = "card " + (/*$images*/ ctx[1][/*index*/ ctx[8]].isRevealed
				? 'revealed'
				: '') + " " + (/*$images*/ ctx[1][/*index*/ ctx[8]].matched
				? 'matched'
				: '') + " mb-1" + " svelte-d7p2ol")) {
				...
				if (dirty & /*$images, $randomIndices*/ 3 && button_disabled_value !== (button_disabled_value = /*$images*/ ctx[1][/*index*/ ctx[8]].matched)) {
					prop_dev(button, "disabled", button_disabled_value);
				}

				if (dirty & /*$images, $randomIndices*/ 3 && div1_class_value !== (div1_class_value = "col-3 col-sm-3 col-lg-3 col" + /*$images*/ ctx[1][/*index*/ ctx[8]].id + " d-flex justify-content-center g-0 colClass" + " svelte-d7p2ol")) {
		...
		dispatch_dev("SvelteRegisterBlock", {
			...
			type: "each",
			source: "(105:2) {#each $randomIndices as index}",
			ctx
		});
	...
	function create_fragment$2(ctx) {
		let div1;
		let div0;
		let each_value = ensure_array_like_dev(/*$randomIndices*/ ctx[0]);
		let each_blocks = [];
		...
		const block = {
			c: function create() {
				...
				add_location(div0, file$2, 103, 1, 2598);
				attr_dev(div1, "class", "container-fluid");
				add_location(div1, file$2, 102, 0, 2567);
			},
			l: function claim(nodes) {
				throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
			},
			...
			p: function update(ctx, [dirty]) {
				if (dirty & /*$images, $randomIndices, handleTileClick*/ 7) {
					each_value = ensure_array_like_dev(/*$randomIndices*/ ctx[0]);
					let i;
	...
	function instance$2($$self, $$props, $$invalidate) {
		...
		component_subscribe($$self, randomIndices, $$value => $$invalidate(0, $randomIndices = $$value));
		...
		$$self.$$.on_mount.push(function () {
			if (onGameCompleted === undefined && !('onGameCompleted' in $$props || $$self.$$.bound[$$self.$$.props['onGameCompleted']])) {
				console.warn("<GameLogic> was created without expected prop 'onGameCompleted'");
			}

			if (matchCount === undefined && !('matchCount' in $$props || $$self.$$.bound[$$self.$$.props['matchCount']])) {
				console.warn("<GameLogic> was created without expected prop 'matchCount'");
			}
		});
		...
		Object.keys($$props).forEach(key => {
			if (!~writable_props.indexOf(key) && key.slice(0, 2) !== '$$' && key !== 'slot') console.warn(`<GameLogic> was created with unknown prop '${key}'`);
		});
	...
	function create_fragment$1(ctx) {
		...
		const block = {
			c: function create() {
				...
				button = element("button");
				i = element("i");
				t2 = text(" Restart Game");
				attr_dev(i, "class", "bi bi-arrow-clockwise");
				add_location(i, file$1, 54, 4, 1173);
				attr_dev(button, "class", "btn btn-primary");
				attr_dev(button, "aria-label", "Restart Game");
				add_location(button, file$1, 49, 2, 1072);
				attr_dev(div, "class", "text-center mt-2");
				add_location(div, file$1, 48, 0, 1039);
			},
			l: function claim(nodes) {
				throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
			},
