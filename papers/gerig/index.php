    ...
    <div class="container-fluid px-0 my-2 mb-4">
        <div class="container px-0">
            <div class="embed-responsive embed-responsive-16by9">
              <iframe width="560" height="315" class="embed-responsive-item" src="https://www.youtube.com/embed/_AsZdXb0l3U" frameborder="0" allow="accelerometer; autoplay; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
            </div>
...
<p>The most notorious form of cult recruitment is brainwashing. The concept of brainwashing developed in the 1950s and refers to the psychological damages seen in cult members. Brainwashing can be defined as, “the personalities and mental capitates that render them incapable of rationally evaluating their continued participation” (Robbins & Anthony, 1982, pg. 283). Through brainwashing techniques, cult members relinquish control of their individuality. Brainwashing is classified as a type of persuasion not coercion. Unlike coercion, brainwashing changes people’s beliefs, not just their actions. In a public press release to the American people the CIA notes that, “brainwashing does not emphasize what happens to the individual, but what happens within him” (CIA, 1956, pg. 5). Throughout this process an individual will lose critical judging capacities, perspective and his belief system. A key component in brainwashing is the persuaders must control the individual’s environment. According to Bauer, “When coercion or the threat of coercion is applied, the individual’s motivation to accommodate may make him a surprisingly willing collaborator in attempting to persuade himself” (Bauer, 1957, pg. 44). This environment is designed to create and sharpen internal conflict within an individual. This conflict creates an opportunity for one’s previous identity to be lost or erased. The process of brainwashing is devastating. When someone is retrieved from a cult, it is common for families to lose hope. The person standing near them is unconnected to the person they know. Brainwashing is an essential tool for cults to become powerful and gain dedicated followers.</p>

<p>In order to combat brainwashing, many mental health professionals utilize a technique called deprogramming. According to Robbins & Anthony, “Deprogramming is the process of persuading cult converts to relinquish their involvement with cults” (Robbins & Anthony, 1982, pg. 286). The widespread successes of deprogramming discredit many cults; it provides evidence that cult conversion is not authentic. After deprogramming therapy has been implemented with a health care professional, followers rapidly return to their own language skills, memories, relationship patterns, and ideologies. Steven Hassan, a Harvard professor and deprogrammer, asserts that the process of deprogramming is often times an uphill battle. This arduous task of helping someone who is brainwashed can be exemplified when Hassan states, “A lie once told remains a lie, but a lie told a thousand times becomes the truth” (Hassan, 2017). Deprogramming requires one to rewire their mind. Although it is difficult, deprogramming is an essential part of the healing process for ex-cult followers. Despite its importance, deprogramming has a complex legal history. In many cult cases, deprogramming can be involuntary. Families will request deprogramming for individuals who may not want help. In these circumstances, cults and their follows argue that their civil liberties are being infringed upon. However, many legal rulings assert that, “the allegation of lack of free will on the part of converts neutralizes the arguments of civil libertarians who claim the therapy is not requested by the ‘victim’” (Robbins & Anthony, 1982, pg. 286). The federal assertion that deprogramming is a beneficial therapy tool is important in order to help people in need. Overall, deprogramming is a necessary instrument to re-assimilate cult followers into everyday life.</p>


<p>Today, over 250,000 Americans are in a cult (Stark et al, 1979, pg. 350). Cults exemplify how powerful and dangerous the tool of persuasion can be. The idea that someone can veer so far from themselves is both unnerving and enthralling. It brings many questions to light about humanity, wrongdoing, and blame. It important that people recognize the warning signs of dangerous persuasive behaviors. Most people would never imagine losing their identities in such a strange and foreign way. Persuasion can be a helpful instrument that helps unify people towards a common goal. Despite this, if persuasion is used with malicious intent there can be dire consequences.</p>
...
<li id='#bib01'>Bauer, R. A. (1957). Brainwashing: Psychology or Demology. Journal of Social Issues, 13(3), 41–47. https://doi.org/10.1111/j.1540-4560.1957.tb02269.x</li>

<li id='#bib02'>CIA. (1956, February). Brainwashing from a Psychological Viewpoint. Retrieved from https://www.cia.gov/library/readingroom/docs/CIA-RDP65-00756R000400050004-9.pdf.</li>

<li id='#bib03'>Chiu, D. (2018, November 18). Jonestown: 13 Things You Should Know About Cult Massacre. Retrieved April 13, 2020, from https://www.rollingstone.com/culture/culture-features/jonestown-13-things-you-should-know-about-cult-massacre-121974/</li>

<li id='#bib04'>Collins, G. (1982, March 15). THE PSYCHOLOGY OF THE CULT EXPERIENCE. Retrieved from https://www.nytimes.com/1982/03/15/style/the-psychology-of-the-cult-experience.html</li>

<li id='#bib05'>Hassan, S. (2017). Is Technology Controlling Your Mind? . Retrieved from https://www.youtube.com/watch?v=wPXBtsR44N0</li>

<li id='#bib06'>Hannaford, A. (2016, July 1). What happened in Colonia? Inside the terrifying Nazi cult that inspired Emma Watson's new film . Retrieved from http://www.telegraph.co.uk/films/2016/07/01/what-happened-in-colonia-inside-the-terrifying-nazi-cult-that-in/.</li>

<li id='#bib07'>Netflix. (2016). Colonia.</li>

<li id='#bib08'>Netflix. (2018). Wild Wild Country.</li>

<li id='#bib09'>Robbins, Thomas, Anthony, & Dick. (2014, July 30). Deprogramming, Brainwashing and the Medicalization of Deviant Religious Groups *. Retrieved from https://doi.org/10.2307/800160</li>

<li id='#bib10'>Rousselet, M., Duretete, O., Hardouin, J., & Grall-Bronnec, M. (2017). Cult membership: What factors contribute to joining or leaving? Psychiatry Research, 257, 27–33. doi: 10.1016/j.psychres.2017.07.018</li>

<li id='#bib11'>Singer, M. T. (2003). Cults in our midst: The continuing fight against their hidden menace (Rev. ed.). Jossey-Bass.</li>
