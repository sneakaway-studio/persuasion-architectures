...
<div class="container">
    ...
    <div class="row my-2">
		...
		<figure class="figure w-100">
			<img src="img/justin-lim-JKjBsuKpatU-unsplash.jpg" alt="thumb" class="figure-img w-100 img-fluid">
			<figcaption class="figure-caption">
				Photo by <a href="https://unsplash.com/@justinlim?utm_content=creditCopyText&utm_medium=referral&utm_source=unsplash">Justin Lim</a>
			</figcaption>
		</figure>
	...
	<div class="container px-0">
		<div class="row">
			<div class="col-12">
				...
				<iframe id="my_iframe" width="100%" height="1160px" frameBorder="0" src="game/start.html" scrolling="no"> </iframe>
